        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <ScrollReveal animation="fadeUp" delay={0.3}>
            <Card variant="glass" className="mt-12 p-8 md:p-10 relative">
              ...
              <blockquote className="text-lg md:text-xl text-slate leading-relaxed italic font-serif">
          ...
          <ScrollReveal animation="fadeUp" delay={0.45}>
            <div className="mt-10 p-8 rounded-xl bg-gradient-to-br from-healing-teal to-deep-teal text-white relative overflow-hidden">
              {/* Decorative elements */}
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <h3 className="font-serif text-xl text-white">Our Vision</h3>
                </div>
